...
local inline = {{{text="قنآهہ‏‏ آلسـورس : الجوكر 🍃",url="t.me/llJOKERll"}}}
return send_inline_key(msg.from.id,'  [قناة السورس : الجوكر](t.me/llJOKERll)',nil,inline)
end
...
if msg.text and redis:get(joker..'replay'..msg.to.id) and msg.to.type == "channel" then
-- by @llJOKERll
